...
4. **Directory Creation** (Sequential)
   - `Create Output Directory`: `mkdir -p /nas/PeggysExtraStorage/videos-to-process/processed/shorts`
   - `Create Scratch Directory`: `mkdir -p /nas/PeggysExtraStorage/videos-to-process/scratch`
...
- **Node.js:** n8n runtime
- **File system:** NAS storage at `/nas/PeggysExtraStorage/`
  ...
  "extracted_shorts": [
    {
      ...
      "path_final": "/nas/PeggysExtraStorage/videos-to-process/processed/shorts/dQw4w9WgXcQ_clip_01_aha_moment.mp4",
      "duration": 28.5
    },
    {
      "index": 2,
      "title": "It's Not Your Fault",
      "path_final": "/nas/PeggysExtraStorage/videos-to-process/processed/shorts/dQw4w9WgXcQ_clip_02_validating_statement.mp4",
      "duration": 22.3
    }
  ],
  "message": "Successfully extracted 5 short video clips with sentence-aware subtitles"
